...
* **Current version**: [`v3.0.3`](https://github.com/neutron-org/neutron/releases/tag/v3.0.3)
...
* **Reference binary**: [neutrond-linux-amd64]([neutrond-linux-amd64](https://github.com/neutron-org/neutron/releases/download/v3.0.3/neutrond-linux-amd64))
* **Binary sha256sum**: `cc33b552cc37ff31843aab08176c3eef82f9dcc9ae6625d7c2314f262c0fbf30`
...
```
$ git clone -b v3.0.3 https://github.com/neutron-org/neutron.git
$ cd neutron
$ make install
```
