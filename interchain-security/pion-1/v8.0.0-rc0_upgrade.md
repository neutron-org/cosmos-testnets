...
- Chain upgrade point: `August 13th 2025, 15:00 UTC (approximately) at height 34542000`;
- Go version: `v1.23`
...
The upgrade will take place approximately on August 13th at `15:00 UTC` approximately at height 34542000;
...
```shell
ERR UPGRADE "v8.0.0-rc0" NEEDED at height: 34542000: upgrade to v8.0.0-rc0 and applying upgrade "v8.0.0-rc0" at height: 34542000
```
...
> neutrond start --unsafe-skip-upgrade 34542000
