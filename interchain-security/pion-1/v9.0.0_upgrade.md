...
The upgrade will take place approximately on November 12th at `14:00 UTC` approximately at height 40007500;
...
The Neutron testnet network, `pion-1`, will run [Neutron v9.0.0](https://github.com/neutron-org/neutron/releases/tag/v9.0.0). Operators _**MUST**_ use this version post-upgrade to remain connected to the network.
