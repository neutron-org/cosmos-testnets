---
title: Neutron v10.0.0-rc0 Upgrade
order: 2
---

<!-- markdown-link-check-disable -->

# Neutron v10.0.0-rc0 Upgrade, Instructions

- Chain upgrade point: `February 5th 2025, 15:00 UTC (approximately) at height 44549000`;
- Go version: `v1.24`
- Release: https://github.com/neutron-org/neutron/releases/tag/v10.0.0-rc0

This document describes the steps for validators and full node operators, to upgrade successfully to the Neutron v10.0.0-rc0 release. For more details on the release, please see the [release notes](https://github.com/neutron-org/neutron/releases/tag/v10.0.0-rc0).

## Upgrade date

The upgrade will take place approximately on February 5th at `15:00 UTC` approximately at height 44549000;
...
The Neutron testnet network, `pion-1`, is currently running [Neutron v9.1.0](https://github.com/neutron-org/neutron/releases/tag/v9.1.0). We anticipate that operators who are running on v9.1.0, will be able to upgrade successfully. Validators are expected to ensure that their systems are up-to-date and capable of performing the upgrade. This includes running the correct binary, or if building from source, building with go `1.23`.

### Target runtime

The Neutron testnet network, `pion-1`, will run [Neutron v10.0.0-rc0](https://github.com/neutron-org/neutron/releases/tag/v10.0.0-rc0). Operators _**MUST**_ use this version post-upgrade to remain connected to the network.
...
## Create the updated Neutron binary of v10.0.0-rc0
...
```shell
   ...
   commit: c3706c9f4330c3f241e2f30d8b4ea4859b7926ac
...
### Or check checksum of the binary if you decided to [download it](https://github.com/neutron-org/neutron/releases/tag/v10.0.0-rc0)

```shell
$ shasum -a 256 neutrond-linux-amd64
73ebadf1c844780005b54e68c6ffcfbd6e85847695565bbc6450790a7052f95e  neutrond-linux-amd64
```
...
3.0.2
```
The proper version is `3.0.2`.

**If the version on your machine is different you MUST change it immediately!**

#### Ways to change libwasmvm

- Use a statically built Neutrond binary from an official Neutron release: [https://github.com/neutron-org/neutron/releases/tag/v10.0.0-rc0](https://github.com/neutron-org/neutron/releases/tag/v10.0.0-rc0)
...
Make sure Neutron v10.0.0-rc0 is installed by either downloading a [compatible binary](https://github.com/neutron-org/neutron/releases/tag/v10.0.0-rc0), or building from source. Building from source requires **Golang 1.24.x**.

Run Neutron v9.1.0 till upgrade height, the node will panic:

```shell
ERR UPGRADE "v10.0.0-rc0" NEEDED at height: 44549000: upgrade to v10.0.0-rc0 and applying upgrade "v10.0.0-rc0" at height: 44549000
```

Stop the node, and switch the binary to **Neutron v10.0.0-rc0** and re-start by `neutrond start`.
...
create a Cosmovisor folder inside `$NEUTRON_HOME` and move Neutron v9.1.0 into `$NEUTRON_HOME/cosmovisor/genesis/bin`
...
Steps to skip this upgrade proposal are simply to resume the pion-1 network with the (downgraded) v9.1.0 binary using the following command:

> neutrond start --unsafe-skip-upgrade 44549000
