...
- Chain upgrade point: `November 28th 2025, 14:00 UTC (approximately) at height 40923500`;
- Go version: `v1.23`
...
The upgrade will take place approximately on November 28th at `14:00 UTC` approximately at height 40923500;
...
The Neutron testnet network, `pion-1`, is currently running [Neutron v9.0.0](https://github.com/neutron-org/neutron/releases/tag/v9.0.0). We anticipate that operators who are running on v9.0.0, will be able to upgrade successfully. Validators are expected to ensure that their systems are up-to-date and capable of performing the upgrade. This includes running the correct binary, or if building from source, building with go `1.23`.

### Target runtime

The Neutron testnet network, `pion-1`, will run [Neutron v9.1.0](https://github.com/neutron-org/neutron/releases/tag/v9.1.0). Operators _**MUST**_ use this version post-upgrade to remain connected to the network.
...
```shell
ERR UPGRADE "v9.1.0" NEEDED at height: 40923500: upgrade to v9.1.0 and applying upgrade "v9.1.0" at height: 40923500
```
...
Steps to skip this upgrade proposal are simply to resume the pion-1 network with the (downgraded) v9.0.0 binary using the following command:

> neutrond start --unsafe-skip-upgrade 40923500
