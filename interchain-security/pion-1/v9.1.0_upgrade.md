...
- Chain upgrade point: `December 1st 2025, 14:00 UTC (approximately) at height 41101000`;
- Go version: `v1.23`
...
The upgrade will take place approximately on December 1st at `14:00 UTC` approximately at height 41101000;
...
```shell
ERR UPGRADE "v9.1.0" NEEDED at height: 41101000: upgrade to v9.1.0 and applying upgrade "v9.1.0" at height: 41101000
```
...
> neutrond start --unsafe-skip-upgrade 41101000
