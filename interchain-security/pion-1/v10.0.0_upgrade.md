...
- Chain upgrade point: `February 4th 2025, 15:00 UTC (approximately) at height 44493000`;
- Go version: `v1.24`
...
The upgrade will take place approximately on February 4th at `15:00 UTC` approximately at height 44493000;
...
The Neutron testnet network, `pion-1`, will run [Neutron v10.0.0](https://github.com/neutron-org/neutron/releases/tag/v10.0.0). Operators _**MUST**_ use this version post-upgrade to remain connected to the network.
...
```shell
ERR UPGRADE "v10.0.0" NEEDED at height: 44493000: upgrade to v10.0.0 and applying upgrade "v10.0.0" at height: 44493000
```
...
> neutrond start --unsafe-skip-upgrade 44493000
