...
- Chain upgrade point: `February 5th 2025, 15:00 UTC (approximately) at height 44552000`;
- Go version: `v1.24`
...
The upgrade will take place approximately on February 5th at `15:00 UTC` approximately at height 44552000;
...
```shell
ERR UPGRADE "v10.0.0" NEEDED at height: 44552000: upgrade to v10.0.0 and applying upgrade "v10.0.0" at height: 44552000
```
...
> neutrond start --unsafe-skip-upgrade 44552000
