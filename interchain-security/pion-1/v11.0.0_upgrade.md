...
- Chain upgrade point: `May 6th, 15:00 UTC (approximately) at height 49831000`;
- Go version: `v1.24`
...
The upgrade will take place approximately on May 6th at `15:00 UTC` approximately at height 49831000;
...
The Neutron testnet network, `pion-1`, is currently running [Neutron v10.0.0-rc0](https://github.com/neutron-org/neutron/releases/tag/v10.0.0-rc0). We anticipate that operators who are running on v10.0.0-rc0, will be able to upgrade successfully. Validators are expected to ensure that their systems are up-to-date and capable of performing the upgrade. This includes running the correct binary, or if building from source, building with go `1.24`.

### Target runtime

The Neutron testnet network, `pion-1`, will run [Neutron v11.0.0](https://github.com/neutron-org/neutron/releases/tag/v11.0.0). Operators _**MUST**_ use this version post-upgrade to remain connected to the network.
...
```shell
   ...
   commit: 2b5b0c49548a016eb318ede459a5909d9149700e
...
a5160b29521e061d0f8e769dc42dc85605070548df55850bfcca89f86883eb88  neutrond-linux-amd64
```
...
Run Neutron v10.0.0-rc0 till upgrade height, the node will panic:

```shell
ERR UPGRADE "v11.0.0" NEEDED at height: 49831000: upgrade to v11.0.0 and applying upgrade "v11.0.0" at height: 49831000
```
...
create a Cosmovisor folder inside `$NEUTRON_HOME` and move Neutron v10.0.0-rc0 into `$NEUTRON_HOME/cosmovisor/genesis/bin`
...
Steps to skip this upgrade proposal are simply to resume the pion-1 network with the (downgraded) v10.0.0-rc0 binary using the following command:

> neutrond start --unsafe-skip-upgrade 49831000
